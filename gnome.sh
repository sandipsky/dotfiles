...
sudo pacman -S zsh zsh-syntax-highlighting zsh-autosuggestions gnome-shell gnome-control-center gnome-calculator nautilus python-nautilus gnome-tweaks gnome-terminal gnome-themes-extra evince loupe gnome-text-editor file-roller xdg-user-dirs-gtk firefox vlc rhythmbox neofetch cmatrix gdm gnome-keyring ntfs-3g gvfs-mtp ffmpegthumbnailer ttf-liberation noto-fonts noto-fonts-emoji noto-fonts-extra --noconfirm --needed
